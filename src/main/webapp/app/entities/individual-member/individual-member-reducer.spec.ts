...
import reducer, {
  ...
  reset,
  updateEntity,
} from './individual-member.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDIVIDUALMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDIVIDUALMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDIVIDUALMEMBER actions', async () => {
      const arg = { id: 30605 };
    ...
    it('dispatches UPDATE_INDIVIDUALMEMBER actions', async () => {
      const arg = { id: 30605 };
    ...
    it('dispatches PARTIAL_UPDATE_INDIVIDUALMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDIVIDUALMEMBER actions', async () => {
      const arg = 42666;
