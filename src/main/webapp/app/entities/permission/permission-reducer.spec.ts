...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERMISSION actions', async () => {
      const arg = { id: 17103 };
    ...
    it('dispatches UPDATE_PERMISSION actions', async () => {
      const arg = { id: 17103 };
    ...
    it('dispatches PARTIAL_UPDATE_PERMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERMISSION actions', async () => {
      const arg = 42666;
