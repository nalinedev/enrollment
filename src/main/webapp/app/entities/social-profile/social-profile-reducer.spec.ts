...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOCIALPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOCIALPROFILE actions', async () => {
      const arg = { id: 16108 };
    ...
    it('dispatches UPDATE_SOCIALPROFILE actions', async () => {
      const arg = { id: 16108 };
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOCIALPROFILE actions', async () => {
      const arg = 42666;
