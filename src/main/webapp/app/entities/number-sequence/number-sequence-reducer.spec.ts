...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUMBERSEQUENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NUMBERSEQUENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NUMBERSEQUENCE actions', async () => {
      const arg = { id: 27812 };
    ...
    it('dispatches UPDATE_NUMBERSEQUENCE actions', async () => {
      const arg = { id: 27812 };
    ...
    it('dispatches PARTIAL_UPDATE_NUMBERSEQUENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NUMBERSEQUENCE actions', async () => {
      const arg = 42666;
