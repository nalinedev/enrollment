...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AQUATICSPECIES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AQUATICSPECIES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AQUATICSPECIES actions', async () => {
      const arg = { id: 16871 };
    ...
    it('dispatches UPDATE_AQUATICSPECIES actions', async () => {
      const arg = { id: 16871 };
    ...
    it('dispatches PARTIAL_UPDATE_AQUATICSPECIES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AQUATICSPECIES actions', async () => {
      const arg = 42666;
