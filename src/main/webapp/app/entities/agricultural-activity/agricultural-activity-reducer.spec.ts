...
import reducer, {
  ...
  reset,
  updateEntity,
} from './agricultural-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGRICULTURALACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGRICULTURALACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGRICULTURALACTIVITY actions', async () => {
      const arg = { id: 13210 };
    ...
    it('dispatches UPDATE_AGRICULTURALACTIVITY actions', async () => {
      const arg = { id: 13210 };
    ...
    it('dispatches PARTIAL_UPDATE_AGRICULTURALACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGRICULTURALACTIVITY actions', async () => {
      const arg = 42666;
