...
import reducer, {
  ...
  reset,
  updateEntity,
} from './livestock-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVESTOCKACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIVESTOCKACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIVESTOCKACTIVITY actions', async () => {
      const arg = { id: 13007 };
    ...
    it('dispatches UPDATE_LIVESTOCKACTIVITY actions', async () => {
      const arg = { id: 13007 };
    ...
    it('dispatches PARTIAL_UPDATE_LIVESTOCKACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIVESTOCKACTIVITY actions', async () => {
      const arg = 42666;
