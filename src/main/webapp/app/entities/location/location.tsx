  ...
  return (
    <div>
      <h2 id="location-heading" data-cy="LocationHeading">
        <Translate contentKey="coopfullApp.location.home.title">Locations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="coopfullApp.location.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/location/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="coopfullApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </div>
      </h2>
        ...
        {locationList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="coopfullApp.location.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="coopfullApp.location.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {locationList.map(location => (
                <tr key={`entity-${location.id}`} data-cy="entityTable">
                  ...
                  <td>{location.name}</td>
                  <td>
                    <Translate contentKey={`coopfullApp.LocationType.${location.type}`} />
                  </td>
                  ...
                  <td>{location.parent ? <Link to={`/location/${location.parent.id}`}>{location.parent.name}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (globalThis.location.href = `/location/${location.id}/delete`)}
                        variant="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coopfullApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
