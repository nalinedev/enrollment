...
import reducer, {
  ...
  reset,
  updateEntity,
} from './economic-activity-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECONOMICACTIVITYTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ECONOMICACTIVITYTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ECONOMICACTIVITYTYPE actions', async () => {
      const arg = { id: 11877 };
    ...
    it('dispatches UPDATE_ECONOMICACTIVITYTYPE actions', async () => {
      const arg = { id: 11877 };
    ...
    it('dispatches PARTIAL_UPDATE_ECONOMICACTIVITYTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ECONOMICACTIVITYTYPE actions', async () => {
      const arg = 42666;
