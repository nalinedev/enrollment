...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRANCHUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRANCHUSER actions', async () => {
      const arg = { id: 11483 };
    ...
    it('dispatches UPDATE_BRANCHUSER actions', async () => {
      const arg = { id: 11483 };
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRANCHUSER actions', async () => {
      const arg = 42666;
