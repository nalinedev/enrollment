...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEMBERDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEMBERDOCUMENT actions', async () => {
      const arg = { id: 30627 };
    ...
    it('dispatches UPDATE_MEMBERDOCUMENT actions', async () => {
      const arg = { id: 30627 };
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEMBERDOCUMENT actions', async () => {
      const arg = 42666;
