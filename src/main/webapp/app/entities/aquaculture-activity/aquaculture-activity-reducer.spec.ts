...
import reducer, {
  ...
  reset,
  updateEntity,
} from './aquaculture-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AQUACULTUREACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AQUACULTUREACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AQUACULTUREACTIVITY actions', async () => {
      const arg = { id: 2247 };
    ...
    it('dispatches UPDATE_AQUACULTUREACTIVITY actions', async () => {
      const arg = { id: 2247 };
    ...
    it('dispatches PARTIAL_UPDATE_AQUACULTUREACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AQUACULTUREACTIVITY actions', async () => {
      const arg = 42666;
