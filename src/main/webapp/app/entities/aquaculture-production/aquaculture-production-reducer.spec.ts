...
import reducer, {
  ...
  reset,
  updateEntity,
} from './aquaculture-production.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AQUACULTUREPRODUCTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AQUACULTUREPRODUCTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AQUACULTUREPRODUCTION actions', async () => {
      const arg = { id: 10739 };
    ...
    it('dispatches UPDATE_AQUACULTUREPRODUCTION actions', async () => {
      const arg = { id: 10739 };
    ...
    it('dispatches PARTIAL_UPDATE_AQUACULTUREPRODUCTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AQUACULTUREPRODUCTION actions', async () => {
      const arg = 42666;
