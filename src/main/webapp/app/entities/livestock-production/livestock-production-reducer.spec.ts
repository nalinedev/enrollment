...
import reducer, {
  ...
  reset,
  updateEntity,
} from './livestock-production.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVESTOCKPRODUCTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIVESTOCKPRODUCTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIVESTOCKPRODUCTION actions', async () => {
      const arg = { id: 27462 };
    ...
    it('dispatches UPDATE_LIVESTOCKPRODUCTION actions', async () => {
      const arg = { id: 27462 };
    ...
    it('dispatches PARTIAL_UPDATE_LIVESTOCKPRODUCTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIVESTOCKPRODUCTION actions', async () => {
      const arg = 42666;
