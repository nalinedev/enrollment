...
import reducer, {
  ...
  reset,
  updateEntity,
} from './agricultural-production.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGRICULTURALPRODUCTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGRICULTURALPRODUCTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGRICULTURALPRODUCTION actions', async () => {
      const arg = { id: 26863 };
    ...
    it('dispatches UPDATE_AGRICULTURALPRODUCTION actions', async () => {
      const arg = { id: 26863 };
    ...
    it('dispatches PARTIAL_UPDATE_AGRICULTURALPRODUCTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGRICULTURALPRODUCTION actions', async () => {
      const arg = 42666;
