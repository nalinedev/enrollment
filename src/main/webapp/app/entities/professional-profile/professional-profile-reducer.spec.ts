...
import reducer, {
  ...
  reset,
  updateEntity,
} from './professional-profile.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSIONALPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFESSIONALPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFESSIONALPROFILE actions', async () => {
      const arg = { id: 6464 };
    ...
    it('dispatches UPDATE_PROFESSIONALPROFILE actions', async () => {
      const arg = { id: 6464 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSIONALPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFESSIONALPROFILE actions', async () => {
      const arg = 42666;
