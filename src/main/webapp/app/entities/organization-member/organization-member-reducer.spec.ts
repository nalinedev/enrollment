...
import reducer, {
  ...
  reset,
  updateEntity,
} from './organization-member.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONMEMBER actions', async () => {
      const arg = { id: 9330 };
    ...
    it('dispatches UPDATE_ORGANIZATIONMEMBER actions', async () => {
      const arg = { id: 9330 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONMEMBER actions', async () => {
      const arg = 42666;
