...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROPVARIETY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROPVARIETY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROPVARIETY actions', async () => {
      const arg = { id: 21293 };
    ...
    it('dispatches UPDATE_CROPVARIETY actions', async () => {
      const arg = { id: 21293 };
    ...
    it('dispatches PARTIAL_UPDATE_CROPVARIETY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROPVARIETY actions', async () => {
      const arg = 42666;
