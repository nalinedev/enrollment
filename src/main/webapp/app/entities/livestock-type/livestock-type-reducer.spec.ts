...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVESTOCKTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIVESTOCKTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIVESTOCKTYPE actions', async () => {
      const arg = { id: 14515 };
    ...
    it('dispatches UPDATE_LIVESTOCKTYPE actions', async () => {
      const arg = { id: 14515 };
    ...
    it('dispatches PARTIAL_UPDATE_LIVESTOCKTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIVESTOCKTYPE actions', async () => {
      const arg = 42666;
