...
import reducer, {
  ...
  reset,
  updateEntity,
} from './cooperative-branch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVEBRANCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COOPERATIVEBRANCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COOPERATIVEBRANCH actions', async () => {
      const arg = { id: 12625 };
    ...
    it('dispatches UPDATE_COOPERATIVEBRANCH actions', async () => {
      const arg = { id: 12625 };
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVEBRANCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COOPERATIVEBRANCH actions', async () => {
      const arg = 42666;
