...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAMILYMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FAMILYMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FAMILYMEMBER actions', async () => {
      const arg = { id: 21491 };
    ...
    it('dispatches UPDATE_FAMILYMEMBER actions', async () => {
      const arg = { id: 21491 };
    ...
    it('dispatches PARTIAL_UPDATE_FAMILYMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FAMILYMEMBER actions', async () => {
      const arg = 42666;
