...
import reducer, {
  ...
  reset,
  updateEntity,
} from './economic-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECONOMICACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ECONOMICACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ECONOMICACTIVITY actions', async () => {
      const arg = { id: 18156 };
    ...
    it('dispatches UPDATE_ECONOMICACTIVITY actions', async () => {
      const arg = { id: 18156 };
    ...
    it('dispatches PARTIAL_UPDATE_ECONOMICACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ECONOMICACTIVITY actions', async () => {
      const arg = 42666;
