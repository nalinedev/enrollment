...
import reducer, {
  ...
  reset,
  updateEntity,
} from './membership-application.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERSHIPAPPLICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEMBERSHIPAPPLICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEMBERSHIPAPPLICATION actions', async () => {
      const arg = { id: 16641 };
    ...
    it('dispatches UPDATE_MEMBERSHIPAPPLICATION actions', async () => {
      const arg = { id: 16641 };
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERSHIPAPPLICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEMBERSHIPAPPLICATION actions', async () => {
      const arg = 42666;
