...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVEUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COOPERATIVEUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COOPERATIVEUSER actions', async () => {
      const arg = { id: 26964 };
    ...
    it('dispatches UPDATE_COOPERATIVEUSER actions', async () => {
      const arg = { id: 26964 };
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVEUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COOPERATIVEUSER actions', async () => {
      const arg = 42666;
