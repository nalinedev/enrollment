...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVEROLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COOPERATIVEROLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COOPERATIVEROLE actions', async () => {
      const arg = { id: 19963 };
    ...
    it('dispatches UPDATE_COOPERATIVEROLE actions', async () => {
      const arg = { id: 19963 };
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVEROLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COOPERATIVEROLE actions', async () => {
      const arg = 42666;
