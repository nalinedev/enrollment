...
/**
 * Criteria class for the {@link com.naline.coopfull.domain.LivestockType} entity. This class is used
 * in {@link com.naline.coopfull.web.rest.LivestockTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /livestock-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class LivestockTypeCriteria implements Serializable, Criteria {
    ...
    public LivestockTypeCriteria() {}

    public LivestockTypeCriteria(LivestockTypeCriteria other) {
    ...
    @Override
    public LivestockTypeCriteria copy() {
        return new LivestockTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LivestockTypeCriteria that = (LivestockTypeCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, scientificName, category, active, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "LivestockTypeCriteria{" +
