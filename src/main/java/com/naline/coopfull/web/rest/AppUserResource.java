...
import com.naline.coopfull.service.AppUserQueryService;
...
/**
 * REST controller for managing {@link com.naline.coopfull.domain.AppUser}.
 */
@RestController
...
public class AppUserResource {
    ...
    /**
     * {@code GET  /app-users} : get all the App Users.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of App Users in body.
     */
    @GetMapping("")
