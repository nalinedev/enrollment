...
import com.naline.coopfull.service.CooperativeQueryService;
import com.naline.coopfull.service.CooperativeService;
...
/**
 * REST controller for managing {@link com.naline.coopfull.domain.Cooperative}.
 */
@RestController
@RequestMapping("/api/cooperatives")
public class CooperativeResource {

    private static final Logger LOG = LoggerFactory.getLogger(CooperativeResource.class);
    ...
    public ResponseEntity<CooperativeDTO> createCooperative(@Valid @RequestBody CooperativeDTO cooperativeDTO) throws URISyntaxException {
        ...
        cooperativeDTO = cooperativeService.save(cooperativeDTO);
        return ResponseEntity.created(new URI("/api/cooperatives/" + cooperativeDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, cooperativeDTO.getId().toString()))
            .body(cooperativeDTO);
    }
    ...
    public ResponseEntity<CooperativeDTO> updateCooperative(
        ...
        cooperativeDTO = cooperativeService.update(cooperativeDTO);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<CooperativeDTO>> getAllCooperatives(CooperativeCriteria criteria) {
        LOG.debug("REST request to get Cooperatives by criteria: {}", criteria);

        List<CooperativeDTO> entityList = cooperativeQueryService.findByCriteria(criteria);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CooperativeDTO> getCooperative(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCooperative(@PathVariable("id") Long id) {
