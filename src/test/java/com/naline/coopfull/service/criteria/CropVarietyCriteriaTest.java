...
class CropVarietyCriteriaTest {
    ...
    private static void setAllFilters(CropVarietyCriteria cropVarietyCriteria) {
        ...
        cropVarietyCriteria.code();
        cropVarietyCriteria.name();
        cropVarietyCriteria.origin();
        cropVarietyCriteria.maturityDays();
        cropVarietyCriteria.yieldPotential();
        cropVarietyCriteria.diseaseResistance();
        cropVarietyCriteria.active();
    ...
    private static Condition<CropVarietyCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getMaturityDays()) &&
                condition.apply(criteria.getYieldPotential()) &&
                condition.apply(criteria.getDiseaseResistance()) &&
    ...
    private static Condition<CropVarietyCriteria> copyFiltersAre(CropVarietyCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getMaturityDays(), copy.getMaturityDays()) &&
                condition.apply(criteria.getYieldPotential(), copy.getYieldPotential()) &&
                condition.apply(criteria.getDiseaseResistance(), copy.getDiseaseResistance()) &&
